/**
 * Created by jluhrsen on 12/1/16.
 */
...
public class DriveService {
    ...
    private static final String APPLICATION_NAME = "jamo-nn-v1";

    private static final String UPLOAD_FILE_PATH = "/tmp";
    private static final String DIR_FOR_DOWNLOADS = "/tmp";
    private static final java.io.File UPLOAD_FILE = new java.io.File(UPLOAD_FILE_PATH);

    /** Directory to store user credentials. */
    private static final java.io.File DATA_STORE_DIR =
            new java.io.File(System.getProperty("user.home"), ".drive_data/creds");
    ...
    private static Credential authorize() throws Exception {
        ...
        InputStreamReader isr = new InputStreamReader(DriveService.class.getResourceAsStream("/client_secrets.json"));
